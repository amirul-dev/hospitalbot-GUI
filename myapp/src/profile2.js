                ...
                <div class="wrapper">
                    <div class="profile-card js-profile-card">
                        ...
                        <div class="profile-card__cnt js-profile-cnt">
                            <div class="profile-card__name">Sree Sankar</div>
                            <div class="profile-card__txt">ID <strong>4725</strong></div>
                            ...
                            <div class="profile-card-inf">
                                <div class="profile-card-inf__item">
                                    <div class="profile-card-inf__title">2/7/22</div>
                                    <div class="profile-card-inf__txt">Previous checkup</div>
                                </div>

                                <div class="profile-card-inf__item">
                                    <div class="profile-card-inf__title">11/7/22</div>
                                    <div class="profile-card-inf__txt">Scheduled checkup</div>
                                </div>

                                <div class="profile-card-inf__item">
                                    <div class="profile-card-inf__title">Critical</div>
                                    <div class="profile-card-inf__txt">Status</div>
                                </div>
                            </div>

                            <div class="profile-card-ctr">
                                <button class="profile-card__button button--blue js-message-btn">Diagnostic History</button>
                                <button class="profile-card__button button--orange">Medicines</button>
                            </div>
                        </div>
